namespace Clutch.Core.Models
{
    ...
    /// <summary>
    /// A captured HTTP request and response, with secrets redacted and bodies truncated to a threshold.
    /// </summary>
    public class RequestHistoryEntry
    {
        ...
        /// <summary>
        /// Tenant identifier. Null for unauthenticated requests.
        /// </summary>
        public string? TenantId { get; set; } = null;

        /// <summary>
        /// User identifier. Null for unauthenticated or credential requests.
        /// </summary>
        ...
        /// <summary>
        /// Route template that matched, or raw path.
        /// </summary>
        ...
        /// <summary>
        /// UTC time the response was sent, if completed.
        /// </summary>
